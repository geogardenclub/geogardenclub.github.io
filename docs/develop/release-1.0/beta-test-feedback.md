...
| Feedback                                                                                                                                                         | Related Screens                           | Contact                                   | Action                                                                |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|-------------------------------------------|-----------------------------------------------------------------------|
| Include apostrophes in garden names to allow names like "Annika's Garden."                                                                                       | Create Garden                             | Annika Sampson                            |                                                                       |
| Notifications/recognition when someone copies your planting.                                                                                                     |                                           | Annika Sampson                            | Issue #191  (Badges to Add)                                           |
| Increase character count for bed names to 10.  All beta testers ran into this limitation when naming new beds.                                                   | Create/Update Garden                      | Jess Meyer, Annika Sampson, Margo Heffron | Issue #225                                                            |
| When adding plantings, provide full list of chapter seed suppliers to attach planting to.  It is common for varieties to be grown by multiple seed growers.      | Create/Update Planting                    | Jess Meyer, Krista Rome, Margo Heffron    |                                                                       |
...
| Tracking of harvest quantities.  Multiple beta testers asked if there was a way to note quantities harvested.                                                    | Update Planting                           | Jess Meyer, Jessie Beck                   | Use Observations for this?  Or a field connected to Harvest Outcomes? |
...
| Don't make tasks for when data for previous years is entered.  When a beta tester entered data from past, it was frustrating to have to then complete the tasks. | Add Planting                              | Krista Rome                               |                                                                       |
