...
| Notifications/recognition when someone copies your planting.                                                                                     |                                           | Annika Sampson                            | Added to "Badges to Add" issue (#191) |
| Increase character count for bed names to 10.  All beta testers ran into this limitation when naming new beds.                                   | Create/Update Garden                      | Jess Meyer, Annika Sampson, Margo Heffron | Created issue (#225)                  |
