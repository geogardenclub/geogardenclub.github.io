...
By the end of the 1.0 release period, we need to have an app that satisfies the [Core Value Propositions](/docs/developer-guide/releases/release-1.0/cvp) while being fast, easy to use, and not prone to crashing.
