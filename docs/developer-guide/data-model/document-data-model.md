...
| Field             | R/O/V    | Type       | Description                                                                                                                                                                                                                                    |
|-------------------|----------|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| taskID            | required | `String`   | (Primary key) A unique ID for this task. Format: `task-<country>-<postalCode>-<gardenNum>-<NNN>-<millis>`. For example, `"task-US-10003-101-002-0283"`.   Please see the [ID Design Pattern documentation](../design/ids.md) for more details. |
