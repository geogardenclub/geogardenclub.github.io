...
To update an existing chapter, click the `Chapter Dropdown` and select the chapter you want to update. Then click the `Update` button. This will take you to the [Update Chapter](update) page.
